        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $sec_post->featured }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $sec_post->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="15_blog_details.html">{{ $sec_post->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
												{{ $sec_post->created_at->toFormattedDateString() }}
                                            </time>
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single', ['id' => $sec_post->category->id ])}}">{{ $sec_post->category->name }}</a>
                                        </span>
					...
					<div class="offers">
						...
						<div class="row">
							<div class="case-item-wrap">
								...
								@foreach($career->posts()->latest()->take(3)->get() as $post)
					...
					<div class="offers">
						...
						<div class="row">
							<div class="case-item-wrap">
								...
								@foreach($tutorials->posts()->latest()->take(3)->get() as $post)
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="case-item">
										<div class="case-item__thumb">
											<img src="{{ $post->featured }}" alt="{{ $post->title }}">
